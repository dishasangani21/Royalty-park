    ...
    <div className=" md:px-3 px-6  bg-white h-full  md:grid grid-cols-2">
      ...
      <div className="   flex flex-col justify-center items-center " >
        ...
        >
          ...
          >
             <span className="text-2xl" >R</span>royalty 
      ...
      <div className=" py-5" >
        <ul className=" text-3xl  flex gap-7 " >
          <li className=" pb-1 hover:text-[green] hover:scale-110 duration-200 "> <Link to={'https://github.com/dishasangani21'} ><AiFillGithub/></Link></li>
          <li className=" pb-1 hover:text-[green] hover:scale-110 duration-200 "> <Link to={'https://www.linkedin.com/in/disha-sangani-53801730b/'} ><CiLinkedin/></Link></li>
